...
<b>]] .. tostring(links)..[[</b>
		...
		elseif msg.content_.ID == "MessageContact" then
			...
			if redis:get("botBOT-IDaddmsg") then
				local answer = redis:get("botBOT-IDaddmsgtext") or "اد شدی عزیزم خصوصی پی ام بده"
